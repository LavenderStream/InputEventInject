...
public class Events {
	...
	public class InputDevice {
		...
		public void tap(int x,int y){
			...
			intSendEvent(m_nId,3,0x0039,0x00000148);
			intSendEvent(m_nId,3,0x0030,0x0000000c);
			intSendEvent(m_nId,3,0x0035,x);
			intSendEvent(m_nId,3,0x0036,y);
			intSendEvent(m_nId,0,0x0000,0x00000000);
			intSendEvent(m_nId,3,0x0039,0xffffffff);
			intSendEvent(m_nId,0,0x0000,0x00000000);
		}
		
		public void slide(){
			intSendEvent(m_nId,3,0x0039,0x000001de);
			intSendEvent(m_nId,3,0x0030,0x00000005);
			intSendEvent(m_nId,3,0x0035,0x00000030);
			intSendEvent(m_nId,3,0x0036,0x00000006);
			intSendEvent(m_nId,0,0x0000,0x00000000);
			intSendEvent(m_nId,3,0x0035,0x00000036);
			intSendEvent(m_nId,3,0x0036,0x0000000e);
			intSendEvent(m_nId,0,0x0000,0x00000000);
			intSendEvent(m_nId,3,0x0035,0x00000033);
			intSendEvent(m_nId,3,0x0036,0x00000045);
			intSendEvent(m_nId,0,0x0000,0x00000000);
			intSendEvent(m_nId,3,0x0035,0x00000012);
			intSendEvent(m_nId,3,0x0036,0x0000007f);
			intSendEvent(m_nId,0,0x0000,0x00000000);
			intSendEvent(m_nId,3,0x0039,0xffffffff);
			intSendEvent(m_nId,0,0x0000,0x00000000);
		}
